  ...
  return (
    <div className='py-3 bg-black  relative text-white'>
        <div className=" bg-black  text-white absolute   w-full  py-10 z-50  md:py-10  ">
         ...
         <Link to="https://github.com/dipeshxhy/netflix-clone">  <span className='flex text-sm text-gray-400'>The source code is available on  <span className='hover:underline ml-1'> Github </span></span></Link> 
         </div>
        </div>
    </div>
  )
